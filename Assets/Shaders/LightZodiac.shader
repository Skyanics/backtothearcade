...
////// Emissive:
                float3 emissive = (pow(1.0-max(0,dot(normalDirection, viewDirection)),(sin(_EmissionBlend)*4.444445+0.5555555))*_Color.rgb);
/// Final Color:
